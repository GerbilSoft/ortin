 ...
 */
typedef enum {
	NITRO_NEC_VIDEO_REG_FORWARD0	= 0x08000004,
	NITRO_NEC_VIDEO_REG_FORWARD1	= 0x08000006,
	NITRO_NEC_VIDEO_REG_FORWARD_EN	= 0x08000008,
	NITRO_NEC_VIDEO_REG_FORWARD_CFG	= 0x0800000A,
	NITRO_NEC_VIDEO_REG_FRAME0	= 0x0800000C,
	NITRO_NEC_VIDEO_REG_FRAME1	= 0x0800000E,

	NITRO_NEC_VIDEO_REG_UNLOCK0	= 0x08000010,
	NITRO_NEC_VIDEO_REG_UNLOCK1	= 0x08000012,
	NITRO_NEC_VIDEO_REG_UNLOCK2	= 0x08000014,
	NITRO_NEC_VIDEO_REG_UNLOCK3	= 0x08000016,

	NITRO_NEC_VIDEO_REG_MONITOR_BG_R	= 0x08000018,
	NITRO_NEC_VIDEO_REG_MONITOR_BG_G	= 0x0800001A,
	NITRO_NEC_VIDEO_REG_MONITOR_BG_B	= 0x0800001C,

	NITRO_NEC_VIDEO_REG_MONITOR_STATE	= 0x0800001E,

	NITRO_NEC_VIDEO_REG_CURSOR_IMAGE_OFFSET	= 0x08000022,
	NITRO_NEC_VIDEO_REG_CURSOR_PIXEL_LO	= 0x08000024,
	NITRO_NEC_VIDEO_REG_CURSOR_PIXEL_HI	= 0x08000026,

	NITRO_NEC_VIDEO_REG_COUNTER_LO		= 0x08000028,
	NITRO_NEC_VIDEO_REG_COUNTER_HI		= 0x0800002A,

	NITRO_NEC_VIDEO_REG_CURSOR_POS_X	= 0x0800002C,
	NITRO_NEC_VIDEO_REG_CURSOR_POS_Y	= 0x0800002E,

	NITRO_NEC_VIDEO_REG_MONITOR_SEL		= 0x08000030,
	NITRO_NEC_VIDEO_REG_MONITOR_DATA_LO	= 0x08000034,
	NITRO_NEC_VIDEO_REG_MONITOR_DATA_HI	= 0x08000036,
